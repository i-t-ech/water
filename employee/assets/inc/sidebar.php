              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->emp_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-airplane"></i><span>Service Providers</span></a>
                  
                    <ul class="sub-menu">
                       <li><a href="emp-add-train.php">Add Service Provider</a>
                       <li><a href="emp-manage-train.php">Manage Service Provider</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="material-icons">person</i><span>Clients</span></a>
                    <ul class="sub-menu">
                      <li><a href="emp-add-passenger.php">Add Clients</a>
                      </li>
                      <li><a href="emp-manage-passengers.php">Manage Clients</a>
                      </li>
