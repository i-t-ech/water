  ...
  <body>
    <div class="be-wrapper be-fixed-sidebar ">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title"> Ticket Checkout </h2>
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Booked Service Provider Nuumber</label>
                      <div class="col-12 col-sm-8 col-lg-6">
