...
<html lang="en">
  ...
  <body>
    <div class="be-wrapper be-fixed-sidebar">
      ...
      <div class="page-head">
          <h2 class="page-head-title">Advanced Service Provider Search</h2>
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              <li class="breadcrumb-item"><a href="pass">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#">Service Providers</a></li>
              <li class="breadcrumb-item active">Advanced Service Provider Search</li>
            </ol>
          </nav>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">Available Service Provider Details
