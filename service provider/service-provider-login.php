...
<?php
    ...
    if(isset($_POST['service-provider-login']))
    {
      $emp_email=$_POST['emp_email'];
      $emp_pwd=sha1(md5($_POST['emp_pwd']));
      $stmt=$mysqli->prepare("SELECT emp_email ,emp_pwd , emp_id FROM  WHERE emp_email=? and emp_pwd=? ");
...
<head>
    ...
    <title>Water Drilling Connection System</title>
      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
            ...
            <div class="splash-footer">&copy;<?php echo date ('Y');?> | Water Drilling Connection System. | Developed By Me</div>
          </div>
        </div>
      </div>
    </div>
